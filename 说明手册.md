...
为便于接收包的更新通知或者交流，请添加[我的微信](https://github.com/tianshu129/foqat/blob/master/img/wechat.jpg) ，以进入FOQAT用户群组。或加入 [FOQAT用户邮件群组](https://groups.google.com/d/forum/foqat), 一个群组邮件列表和Q/A论坛。
``` r
