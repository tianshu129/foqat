...
2020/7/27 7.3-8.6本包通过克隆方式下载的次数达到329次。  

2020/8/6 v1.3.2 更新了openaq功能，用于处理从openaq.org下载的历史AQI数据。
...
* [处理openAQ下载的历史空气质量数据（openaq）](#处理openAQ下载的历史空气质量数据-openaq)
...
### 处理openAQ下载的历史空气质量数据（openaq）
----------
* #### 描述

处理从openaq在亚马逊云上的数据库下载的历史空气质量数据。
...
| 变量名             | 含义                              | 默认值                     |示例值/备注                            |
| ------------------| ----------------------------------|----------------------------|--------------------------------------|
| `df`              | 从openaq在亚马逊云上的数据库下载的具有特定格式的AQI数据|  |需要包含五个物种： "o3", "no2", "co", "pm25", "pm10"。|
...
2020/8/6 v1.3.2 更新了open功能，用于处理从openaq.org下载的历史数据。

2020/8/5 v1.3.1 更新了ofp功能，解决了汇总大类时NA+NA=0的问题。

2020/8/5 v1.3.0 更新了ofp功能，丰富了输出。   
