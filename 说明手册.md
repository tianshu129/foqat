...
| ------------------| ----------------------------------|----------------------------|--------------------------------------|
| `df`              | 时间序列的数据框                    |                            |                                     |
| `bkip`            | 重采样的时间区间长度                |                            | '1 hour' 。注意：时间分辨率的单位需要与开始时间的最小非零位的单位相对应（或者比它小），例如设置开始时间是“2020-06-09 00:02:00”，则非零位是分钟。如果你要换算成小时分辨率，时间分辨率只能写”60 mins"不能写“1 hour"。如果你想要得到整点间隔的结果，则需要设置开始时间st="2020-06-09 00:00:00”  。                                 |
| `colid`           | 时间列的列号                       |                            |                                      |
| `st`              | 开始时间                           | NULL                       | 默认取时间序列开始时间。开始时间决定了新时间序列的第一个时间。例如原始序列开始时间为“2020-06-09 00:02:00”，时间分辨率设置为“60 mins"的话，则新时间序列也会从“2020-06-09 00:02:00”开始，下一个时间是2020-06-09 01:02:00”。注意此处时间分辨率必须是写“60 min"。因为你的开始时间并不是整点，所以不可以写”1 hour"。如果你想要得到整点间隔的结果，则需要设置开始时间st="2020-06-09 00:00:00” 。|
