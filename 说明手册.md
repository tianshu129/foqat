...
如果本包被用于支持科研文章，请您参考如下格式进行引用，并[邮件](mailto:tianshu129@163.com)告知我。我正在建立一个采用本包的文章的列表。非常感谢！
...
| ------------------| ----------------------------------|----------------------------|--------------------------------------|
| `df`              | VOC时间序列的数据框                |                            |                                      |
| `unit`            | VOC数据的单位（微克每立方米或者ppb)。填写"ugm"或者"ppb"(带英文引号）。  | "ugm"|                           |   
