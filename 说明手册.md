...
## 动态
注意！！！为便于接收包的更新通知或者交流，请添加[我的微信](https://github.com/tianshu129/foqat/blob/master/img/wechat.jpg) ，以进入FOQAT用户微信群组。或加入 [FOQAT用户邮件群组](https://groups.google.com/d/forum/foqat)，一个群组邮件列表和Q/A论坛。本说明手册适合R语言零基础用户上手，请放心阅读。
...
``` r
library(downloader)
download("https://github.com/tianshu129/foqat/archive/v1.2.3.tar.gz", "foqat.tar.gz")
...
本项目耗费了很多时间和精力，但作者坚持免费开源。如果本项目对你有帮助，欢迎打赏，非常感谢：  
