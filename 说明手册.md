...
如果本包被用于支持科研文章，请您参考如下格式进行引用，并[邮件](tianshu129@163.com)告知我。我正在建立一个采用本包的文章的列表。非常感谢！
...
v1.1.0全面更新了R包中的帮助文档。增加英文版本说明手册。取消了数据重采样和平均变化两个函数的输出结果中风速、风向列自动移动到第2、3列的设定，风向、风速将保持原始列号。  
