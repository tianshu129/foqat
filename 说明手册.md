...
2020/7/22 v1.2.0增加了批量线性回归分析功能anylm，详情请点击阅读[批量线性回归分析利器anylm——FOQAT包的重要更新](https://zhuanlan.zhihu.com/p/162841404)。

2020/7/12 v1.1.0全面更新了R包中的帮助文档。增加英文版说明手册。取消了数据重采样和平均变化两个函数的输出结果中风速、风向列自动移动到第2、3列的设定，风向、风速将保持原始列号。  
