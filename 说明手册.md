...
| `sortd`           | 逻辑值，是否为VOC时间序列中的物种排序。         | TRUE                       |排序优先级一次为：VOC大类、分子质量、MIR值。 VOC大类包括c("Alkanes", "Alkenes", "BVOC", "Alkynes", "Aromatic_Hydrocarbons", "Oxygenated_Organics", "Other_Organic_Compounds", "Unknown")                                    |
| `colid`           | 时间列的列号                       |                            |                                      |
